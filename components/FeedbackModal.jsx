...
import { StarsBackgroundDemo } from "./demo-stars-bg";
...
export const FeedbackModal = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='bg-black border border-violet-500/20 text-stone-100 sm:max-w-3xl max-h-[85vh] overflow-y-auto'>
        <StarsBackgroundDemo />
