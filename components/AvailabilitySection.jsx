  ...
  return (
    <section className='bg-[#0f0f11] border border-white/10 rounded-2xl p-8 flex flex-col gap-7'>
      ...
      <div className='flex items-start justify-between gap-4'>
        <div>
          <span className='w-10 h-10 rounded-xl bg-violet-500/10 border border-violet-500/20 flex items-center justify-center text-lg mb-4'>
      ...
      {duration && (
        <div className='flex items-center gap-3'>
          <Badge
            variant='outline'
            className='border-violet-500/20 bg-violet-500/5 text-violet-400'
          >
            {duration} window
          </Badge>
