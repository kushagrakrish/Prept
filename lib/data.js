...
export const SLOTS = [
  {
    label: "Mon 10:00 AM",
    cls: "border-violet-500/30 text-violet-200 bg-violet-500/5",
  },
...
export const STATUS_STYLES = {
  SCHEDULED: "border-violet-500/20 bg-violet-500/10 text-violet-400",
...
export const RATING_STYLES = {
  ...
  GOOD: "ml-auto border-violet-500/20 bg-violet-500/10 text-violet-400",
  EXCELLENT: "ml-auto border-cyan-500/20 bg-cyan-500/10 text-cyan-400",
};
